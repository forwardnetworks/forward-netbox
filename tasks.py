...
def architecture_runtime_evidence(
    ...
    adp_evidence = {
        "status": "failed",
        "evidence": (
            "CustomerOrg runtime matrix not executed in this local evidence run. "
            "Run with --run-validation-org=True in an environment with approved CustomerOrg credentials "
