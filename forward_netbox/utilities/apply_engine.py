...
from .apply_engine_bulk import bulk_orm_apply_simple_models as _bulk_orm_apply_simple_models_impl
from .apply_engine_bulk import bulk_orm_apply_tree_models as _bulk_orm_apply_tree_models_impl
...
from .apply_engine_decision import ADAPTER_MODELS_WITHOUT_BLOCKER
from .apply_engine_decision import ADAPTER_MODEL_BLOCKERS
from .apply_engine_decision import ADAPTER_REQUIRED_MODELS
from .apply_engine_decision import APPLY_ENGINE_MODEL_CLASSIFICATIONS
from .apply_engine_decision import BULK_ORM_ENABLED_MODELS_WITHOUT_SPECS
from .apply_engine_decision import BULK_ORM_ENABLED_MODELS
from .apply_engine_decision import BULK_ORM_SPEC_MODELS
from .apply_engine_decision import EXPERIMENTAL_BULK_ORM_MODELS
from .apply_engine_decision import SIMPLE_BULK_CANDIDATE_MODELS
from .apply_engine_decision import UNCLASSIFIED_SUPPORTED_MODELS
from .apply_engine_decision import ForwardApplyEngineDecision
...
class ForwardApplyEngine:
    ...
    def apply_upserts(self, runner, model_string, rows):
        if (
            ...
            and model_string in (BULK_ORM_ENABLED_MODELS | EXPERIMENTAL_BULK_ORM_MODELS)
        ):
...
def apply_engine_decision_for(*, sync, model_string, backend):
    ...
    _decision_mod.BULK_ORM_ENABLED_MODELS_WITHOUT_SPECS = BULK_ORM_ENABLED_MODELS_WITHOUT_SPECS
