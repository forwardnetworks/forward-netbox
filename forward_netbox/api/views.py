...
class ForwardSyncViewSet(NetBoxModelViewSet):
    ...
    @action(detail=True, methods=["post"], url_path="recover-stuck-sync")
    def recover_stuck_sync(self, request, pk):
        return self._enqueue_button_job_response(request, "recover_stuck_sync")
    ...
    @action(detail=True, methods=["post"], url_path="prune-uncovered")
    def prune_uncovered(self, request, pk):
        return self._enqueue_button_job_response(request, "prune_uncovered")
    ...
    def merge_site_relabel_duplicates(self, request, pk):
        return self._enqueue_button_job_response(
            request, "merge_site_relabel_duplicates"
        )
    ...
    @action(detail=True, methods=["post"], url_path="prune-stale-hardware-notices")
    def prune_stale_hardware_notices(self, request, pk):
        return self._enqueue_button_job_response(
