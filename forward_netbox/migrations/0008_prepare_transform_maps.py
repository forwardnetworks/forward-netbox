...
def prepare_transform_maps(apps: "apps", schema_editor: "BaseDatabaseSchemaEditor"):
    ...
    """
    if apps.get_model("forward_netbox", "ForwardTransformMap").objects.count() == 0:
...
def cleanup_transform_maps(apps: "apps", schema_editor: "BaseDatabaseSchemaEditor"):
    ...
    # ForwardTransformField and ForwardRelationshipField are deleted by CASCADE
    apps.get_model("forward_netbox", "ForwardTransformMap").objects.all().delete()
