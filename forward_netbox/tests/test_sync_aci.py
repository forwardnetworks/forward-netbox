...
class SyncACIAdapterTest(TestCase):
    ...
    def test_acinode_links_its_device_case_insensitively(self):
        # APIC names nodes as configured (SWITCH101); Forward collected the
        # device as switch101. 0 of 667 nodes matched exactly on a real fabric.
        runner = _ACIRunner()
        device = SimpleNamespace(pk=7, __class__=type("Device", (), {}))
        runner.devices["switch101"] = device
