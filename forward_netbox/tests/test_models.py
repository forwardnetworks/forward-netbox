...
class ForwardTransformMapModelTestCase(TestCase):
    def setUp(self):
        ...
        snapshot = ForwardSnapshot.objects.create(
            name="S01 - Day 2 - FWD Lab - 02-Jul-21 06:29:16 - 12dd8c61-129c-431a-b98b-4c9211571f89",
            source=source,
    ...
    def test_transform_map(self):
        site_transform_map = ForwardTransformMap.objects.get(name="Site Transform Map")
    ...
    def test_transform_field(self):
        site_transform_map = ForwardTransformMap.objects.get(name="Site Transform Map")
        site_slug_field = ForwardTransformField.objects.get(
        ...
        site_name_field = ForwardTransformField.objects.get(
            source_field="siteName",
            target_field="name",
            transform_map=site_transform_map,
        )
    ...
    def test_transform_map_serialization(self):
        ...
        test_data = {
            "model": "forward_netbox.forwardtransformmap",
    ...
    def test_transform_field_serialization(self):
        ...
        data = json.loads(data)[0]
        test_data = {
            "model": "forward_netbox.forwardtransformfield",
    ...
    def test_alter_transform_field_template(self):
        sync = ForwardSync.objects.get(name="ingest")
        ...
        transform_field = ForwardTransformField.objects.get(
