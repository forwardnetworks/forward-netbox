...
This section is the operator and agent harness for `forward-netbox`. It exists to keep repo knowledge close to the code and easy to validate mechanically.
