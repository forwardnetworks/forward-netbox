...
Investigate REDACTED's report that prefixes show "too many updates" each sync, and
...
- Therefore the remaining "prefix updates" REDACTED sees are most likely true
