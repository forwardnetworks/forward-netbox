...
word-boundary regex (`re:\bExampleCustomer\b`) to avoid substring false positives
(literal patterns match case-insensitively as substrings — e.g. bare `ExampleCustomer`
matches `ThreadPool`).
