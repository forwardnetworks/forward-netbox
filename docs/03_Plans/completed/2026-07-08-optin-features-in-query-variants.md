...
- Never commit validation-organization network identifiers or tokens; validate live via the local source.
...
Live against the validation network: alias query `sync_endpoints` off→5021 rows,
on→5709 (+688; 355 Avocent/Console Server; sample `console-server-example / Avocent /
