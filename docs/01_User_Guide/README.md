...
| --- | --- | --- |
| `v1.7.0` | `4.5.9` and `4.6.2` validated; shared branch for `4.5.x` and `4.6.x` with capability-gated 4.6 features | Current release; ACI bridge domain and L3Out NQE maps; query publish hardening |
