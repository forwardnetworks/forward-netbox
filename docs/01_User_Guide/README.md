...
| --- | --- | --- |
| `v2.1.3` | `4.6.3` required (4.5.x dropped); needs netbox-branching `1.1.0+` | Current release; Prune empty orphan sites (zero devices + zero racks) alongside out-of-scope devices |
