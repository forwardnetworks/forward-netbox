...
The `2.6.1` release requires NetBox `4.6.5` and `netbox-branching` `1.1.1`. Expand for the published release history and release notes.
...
| --- | --- | --- |
| `v2.6.1` | `4.6.5` required; needs netbox-branching `1.1.1` | Current release; Compatibility fix: restores the supported Python range to `>=3.10,<3.15` (including Python 3.12) without changing runtime behavior. |
