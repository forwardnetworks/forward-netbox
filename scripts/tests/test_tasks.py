...
class ReleaseArtifactTaskTest(unittest.TestCase):
    def _context(self, netbox_version="v4.7.1"):
    ...
    def test_artifact_test_uses_wheel_without_source_fallback(self):
        ...
        self.assertIn("--build-arg NETBOX_VER=v4.7.1", commands[0])
        self.assertIn(
        ...
        self.assertIn('version = "4.7.1"', commands[2])
...
class ArtifactUpgradeTaskTest(unittest.TestCase):
    ...
    def _context(self, netbox_version="v4.7.1", tags="v2.6.5\nv2.6.6\n"):
