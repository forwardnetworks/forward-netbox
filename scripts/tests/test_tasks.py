...
class ReleaseArtifactTaskTest(unittest.TestCase):
    def _context(self, netbox_version="v4.6.10"):
    ...
    def test_artifact_test_uses_wheel_without_source_fallback(self):
        ...
        self.assertIn("--build-arg NETBOX_VER=v4.6.10", commands[0])
        self.assertIn(
        ...
        self.assertIn('version = "4.6.10"', commands[2])
    ...
    def test_release_workflow_blocks_publish_on_artifact_and_pinned_sbom(self):
        ...
        self.assertNotIn("refs/tags/v2.9.1:", workflow)
...
class ArtifactUpgradeTaskTest(unittest.TestCase):
    ...
    def _context(self, netbox_version="v4.6.10", tags="v2.6.5\nv2.6.6\n"):
